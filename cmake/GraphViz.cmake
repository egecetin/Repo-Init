...
set(DOT_OUTPUT_TYPE
    "svg"
    CACHE STRING "Build a dependency graph. Options are dot output types: ps, png, pdf...")

if(DOT_EXE)
  add_custom_target(
    dependency-graph
    COMMAND ${CMAKE_COMMAND} ${PROJECT_SOURCE_DIR} --graphviz=${PROJECT_BINARY_DIR}/graphviz/${PROJECT_NAME}.dot
    COMMAND ${DOT_EXE} -T${DOT_OUTPUT_TYPE} ${PROJECT_BINARY_DIR}/graphviz/${PROJECT_NAME}.dot -o

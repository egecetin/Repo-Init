...
macro(link_time_optimization)
	...
	cmake_parse_arguments(link_time_optimization "${options}" "${single_value_keywords}" "${multi_value_keywords}" ${ARGN})
...
function(target_link_time_optimization TARGET_NAME)
	...
	set(single_value_keywords)
	set(multi_value_keywords)
	cmake_parse_arguments(target_link_time_optimization "${options}" "${single_value_keywords}" "${multi_value_keywords}" ${ARGN})
	...
	if(result)
		...
		if(target_link_time_optimization_REQUIRED)
			message(FATAL_ERROR "Link Time Optimization not supported, but listed as REQUIRED for the ${TARGET_NAME} target: ${output}")
		else()
			message(WARNING "Link Time Optimization not supported: ${output}")
		endif()
	endif()
